...
var _distanceBetween = _interopRequireDefault(
  require("coffeekraken-sugar/js/geom/2d/distanceBetween")
)

var _circleConstrain = _interopRequireDefault(
  require("coffeekraken-sugar/js/geom/2d/circleConstrain")
)
  ...
  (function(_SWebComponent) {
    ...
    function SSpringSnapComponent() {
      ...
      return _possibleConstructorReturn(
        this,
        _getPrototypeOf(SSpringSnapComponent).apply(this, arguments)
      )
    }

    _createClass(
      SSpringSnapComponent,
      [
        {
          ...
          value: function componentWillMount() {
            _get(
              _getPrototypeOf(SSpringSnapComponent.prototype),
              "componentWillMount",
              this
        ...
        },
        {
          ...
          value: function componentMount() {
            _get(
              ...
              "componentMount",
              this
            ).call(this) // add mouse move handler

            this._mouseMoveRemoveListener = (0, _addEventListener.default)(
              document,
              "mousemove",
              (0, _throttle.default)(this._mouseMoveHandler, 50),
              this
            )
          }
          /**
        ...
        },
        {
          ...
          value: function componentUnmount() {
            _get(
              ...
              "componentUnmount",
              this
            ).call(this) // remove event listeners
        ...
        },
        {
          ...
          value: function _mouseMoveHandler(e) {
            ...
            switch (this.props.distanceDetectionMethod) {
              case "circular":
                distance = (0, _distanceBetween.default)(
                  this._pos,
                  this._mousePos
                )
              ...
              default:
                if (this._mousePos.x < this._pos.x) {
                  distX =
                    this._pos.x - this.offsetWidth * 0.5 - this._mousePos.x
                } else {
                  distX =
                    this._mousePos.x - (this._pos.x + this.offsetWidth * 0.5)
                }

                if (this._mousePos.y < this._pos.y) {
                  distY =
                    this._pos.y - this.offsetHeight * 0.5 - this._mousePos.y
                } else {
                  distY =
                    this._mousePos.y - (this._pos.y + this.offsetHeight * 0.5)
                }

                needToSnap =
                  distX <= this.props.snapDistance &&
                  distY <= this.props.snapDistance
                break
            } //
            ...
            if (needToSnap && !this._returnToHome) {
              ...
              if (this.props.maxTranslate) {
                var limit = (0, _circleConstrain.default)(
                  this._pos,
